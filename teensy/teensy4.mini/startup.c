...
//void HardFault_HandlerC(unsigned int *hardfault_args) __attribute__((used)); // for LTO
__attribute__((naked))
FASTRUN void unused_interrupt_vector(void)
{
...
__attribute__((weak))
FASTRUN void HardFault_HandlerC(unsigned int *hardfault_args)
{
